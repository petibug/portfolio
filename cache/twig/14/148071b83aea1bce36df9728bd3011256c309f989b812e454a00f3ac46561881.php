...
/* preview.html.twig */
class __TwigTemplate_2faab6f1d14ef2c73b993ba7c7f8a4c29d44e5322c31db09a3a2af3119d2399d extends Twig_Template
{
    ...
    {
        // line 3
        $context["route"] = ((($this->getAttribute((isset($context["admin"]) ? $context["admin"] : null), "route", array()) == "")) ? ("") : (("/" . $this->getAttribute((isset($context["admin"]) ? $context["admin"] : null), "route", array()))));
        // line 4
        $context["preview_link"] = ($this->env->getExtension('Grav\Common\Twig\TwigExtension')->rtrimFilter((isset($context["base_url_relative_frontend"]) ? $context["base_url_relative_frontend"] : null), "/") . (isset($context["route"]) ? $context["route"] : null));
        // line 5
        ...
        // line 6
        $context["admin_route"] = ("/" . $this->getAttribute((isset($context["admin"]) ? $context["admin"] : null), "route", array()));
        // line 7
        $context["back_link"] = (($this->env->getExtension('Grav\Common\Twig\TwigExtension')->rtrimFilter((isset($context["base_url"]) ? $context["base_url"] : null), "/") . "/pages") . $this->getAttribute($this->getAttribute((isset($context["page"]) ? $context["page"] : null), "find", array(0 => (isset($context["admin_route"]) ? $context["admin_route"] : null)), "method"), "rawRoute", array(), "method"));
        // line 1
    ...
    public function block_titlebar($context, array $blocks = array())
    {
        ...
        <a class=\"button\" href=\"";
        // line 11
        echo twig_escape_filter($this->env, (isset($context["back_link"]) ? $context["back_link"] : null), "html", null, true);
...
{% endblock %}
", "preview.html.twig", "E:\\WEB-DEV\\Test\\grav-admin\\user\\plugins\\admin\\themes\\grav\\templates\\preview.html.twig");
    }
}
